...
public class PipiModItems {
    ...
    public static void init() {
        Registry.register(Registry.ITEM, new Identifier(PipiMod.MODID, "pipi_spawn_egg"), PIPI_SPAWN_EGG);
        Registry.register(Registry.ITEM, new Identifier(PipiMod.MODID, "mushroom_pipi_spawn_egg"), MUSHROOM_PIPI_SPAWN_EGG);
    }
}
